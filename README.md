# genpark-automated-benchmark-patch-verification-harness-skill
...
> **GenPark AI Agent Skill** -- Automated benchmark patch verification harness & fail-to-pass matrix (SWE-bench)
